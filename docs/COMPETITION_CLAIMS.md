...
| Independent Dist D (not A/B/C) | **MEASURED** one-shot seed 37: F1 0.7397 / recall 1.0 / precision 0.587 / FPR 0.3585 (missed precision≥0.80 FPR≤0.10) | `reports/dist_d.json`. Freeze `reports/dist_d_freeze.json`. Clinic/tithe 0 flagged; mill pass-through FPs. Do not retune. |
