...
| Independent Dist F (not A–E) | **VERIFIED** one-shot seed 47: F1 1.0 / recall 1.0 / precision 1.0 / FPR 0.0 / taxonomy 0.25 (exact pattern_accuracy 0.0) | `reports/dist_f.json`. Freeze `reports/dist_f_freeze.json`. FAMILY eval-only; trade_overbill unmapped novel_detection_recall 1.0. Do not retune. |
