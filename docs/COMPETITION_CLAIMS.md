...
| Gemini agreement | **VERIFIED 1.0, n=100** | `reports/gemini_agreement.json` invoked 100/100 |
| Gemini p95 | **VERIFIED 4.025 s** (4025.4 ms, gate 8000) | `gemini-2.5-flash` |
| Gemini cost/case | **VERIFIED $0.00143** | same artifact |
