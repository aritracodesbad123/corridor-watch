...
run_id `b772ab46da8e` commit `8323b0486fc19d8b2c8b32a8200cce39d7269438`. Seed `42`.
...
| Dist D F1 | Measured F1 0.7397 recall 1.0 FPR 0.3585 (seed 37 one-shot) | `reports/dist_d.json` (freeze `reports/dist_d_freeze.json`) |
