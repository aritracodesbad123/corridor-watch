...
| Dist E F1 | same on generator E (frozen seed 41, one-shot) | 0–1 | Dist E rows | recall≥0.90 precision≥0.80 FPR≤0.10 | `reports/dist_e.json` (freeze `dist_e_freeze.json`) | deterministic | small n | Post-D holdout; do not retune on seed 41 |
