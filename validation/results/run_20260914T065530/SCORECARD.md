...
run_id `e925c055d4ea` commit `8beb0b0deed4938e87516e931ea79ee35a91b524`. Seed `42`.
...
| Gemini vs deterministic agreement | Verified **0.949** schema_valid n=98 / invoked 98 CI=[0.8861, 0.978] (gate 0.85) | `reports/gemini_agreement.json` |
| Hallucination rate | Verified 0.0 (live ungrounded n=100; trap/gate) | `reports/hallucination.json` |
| Unsupported claim rate | Verified 0.5 | `reports/hallucination.json` |
| Gemini cost per case | Verified $ 0.002387 | `reports/gemini_agreement.json` |
| Gemini tokens per case | Verified 1973.3 | `reports/gemini_agreement.json` |
| Gemini p95 | Missed 18928.3 ms (gate 8000) | `reports/gemini_agreement.json` |
