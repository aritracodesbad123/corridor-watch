...
run_id `851e6ee5b6ee` commit `8beb0b0deed4938e87516e931ea79ee35a91b524`. Seed `42`.
...
| Gemini vs deterministic agreement | Verified **1.0** schema_valid n=48 / invoked 100 CI=[0.9259, 1.0] (gate 0.85) | `reports/gemini_agreement.json` |
...
| Gemini cost per case | Verified $ 0.00241 | `reports/gemini_agreement.json` |
| Gemini tokens per case | Verified 1977.8 | `reports/gemini_agreement.json` |
| Gemini p95 | Missed 17186.2 ms (gate 8000) | `reports/gemini_agreement.json` |
